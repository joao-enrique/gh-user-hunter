...
async function searchUser(){
    ...
    if(!username) return alert("Coloque um nome de usuário...")
    ...
    try{
        ...
        console.log("use data is here", userData)
...
function displayUserData(user){
    ...
    bioElement.textContent = user.bio || "Sem Biografia"

    locationElement.textContent = user.location || "Não especificado"
...
searchInput.value = "joao-enrique"
searchUser()